...
singularity exec --env NEPTUNE_API_TOKEN=$NEPTUNE_API_TOKEN -B $TMPDIR:/home/tmpdir -B $WORK/ucdr:/home/work -B $HOME:/home/git --nv --writable --containall $TMPDIR/ucdr.sif /home/git/continual_adaptation_ucdr/cfg/docker/container_run.sh $@
